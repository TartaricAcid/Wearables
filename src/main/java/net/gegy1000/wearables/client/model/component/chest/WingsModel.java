...
public class WingsModel extends WearableComponentModel {
    ...
    public WingsModel() {
        ...
        this.shape51 = new ModelRenderer(this, 13, 10);
        this.shape51.mirror = true;
        this.shape51.setRotationPoint(0.0F, 0.2F, 1.0F);
        this.shape51.addBox(-13.0F, 0.0F, 0.0F, 13, 0, 18, 0.0F);
        ...
        this.shape51_2 = new ModelRenderer(this, 13, 10);
        this.shape51_2.setRotationPoint(-0.2F, 0.2F, 1.0F);
        this.shape51_2.addBox(0.0F, 0.0F, 0.0F, 13, 0, 18, 0.0F);
